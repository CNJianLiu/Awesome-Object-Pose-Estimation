...
This is the official repository of paper [''Deep Learning-Based Object Pose Estimation: A Comprehensive Survey''](https://arxiv.org/pdf/2405.07801v3) published in <b>*IJCV'25*</b>. Specifically, we first introduce the [datasets](#2-datasets) used for object pose estimation. Then, we review the [instance-level](#3-instance-level), [category-level](#4-category-level), and [unseen](#5-unseen) methods, respectively. Finally, we summarize the common [applications](#6-applications) of this task. The taxonomy of this survey is shown as follows
